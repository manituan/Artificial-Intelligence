...
AIMelee::AIMelee(bool bIsAttacking, int type, int race, Ogre::Vector2 position, Ogre::Vector2 orientation)
{
    ...
    m_pStateMachine = new AIStateSystem<AIMelee>(this);
    m_pStateMachine->SetCurrentState(SeekToFlagMelee::Instance());
}

void AIMelee::Update(double timeElapsed)
{
...
bool AIMelee::HandleMessage(const Telegram& msg)
{
  return m_pStateMachine->HandleMessage(msg);
}

Ogre::Vector2 AIMelee::seekFlag()
{
    m_iAnimation = WALK;
    if(this->IsAttacking())
    {

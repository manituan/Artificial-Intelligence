...
GraphWizard::GraphWizard(int senderID, int UnitType, int Race, Ogre::Vector2 vPos, Ogre::Vector2 vRot, Ogre::Vector2 vHealth)
{
...
/*
	case HUMAN:
		{    
            m_pInstancedEntity = OgreFramework::getSingletonPtr()->m_pInstanceMgrHumanWizard->createInstancedEntity("Examples/Instancing/VTF/Human_Wizard");
		}
		break;
*/
    case BEAST:
        {
            m_pInstancedEntity = OgreFramework::getSingletonPtr()->m_pInstanceMgrBeastWizard->createInstancedEntity("Examples/Instancing/VTF/Beast_Wizard");
        }
        break;

    case UNDEAD:
        {
            m_pInstancedEntity = OgreFramework::getSingletonPtr()->m_pInstanceMgrUndeadWizard->createInstancedEntity("Examples/Instancing/VTF/Undead_Wizard"); 
        }
        break;
...
GraphWizard::~GraphWizard()
{
    m_pInstancedEntity->setVisible(false);
}

bool GraphWizard::HandleMessage(const Telegram& msg)
{
    switch( msg.Msg )
	{
...
void GraphWizard::Update(double timeSinceLastFrame)
{

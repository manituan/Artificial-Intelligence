...
void GraphBuilding::setNodeTraslation(float x, float y, float z, float delta)
{
    m_pNode->setPosition(Vector3(x,y,z));
}

void GraphBuilding::setNodeOrientation(const Telegram& msg)
{
...
void GraphBuilding::setNodeAnimation(const Telegram& msg)
{
...
void GraphBuilding::updateLifeBar(Ogre::Billboard* pLifeBar, Ogre::Real life, Ogre::Real maxLife) {
...
void GraphBuilding::createLifeBar(Ogre::Vector3 scale) 
{
